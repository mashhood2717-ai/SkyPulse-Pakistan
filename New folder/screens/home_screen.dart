...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _restoreInitialLocation(WeatherProvider provider) {
    if (_cachedInitialWeather != null && _initialLocationCity != null) {
      // Restore the cached initial weather data instantly
  ...
  void _goToHome() {
    if (_currentPage != 0) {
      // Just animate to page 0, let onPageChanged handle the rest
          ...
          child: Consumer<WeatherProvider>(
            builder: (context, provider, child) {
              ...
              return RefreshIndicator(
                onRefresh: () async {
                  if (_currentPage == 0) {
                    // On page 0 - refresh GPS location
                    ...
                    // On other pages - refresh current city
        ...
        children: [
          PageView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final verticalPadding = isActive ? 10.0 : 30.0;
  ...
  Widget _buildFavoriteCard(String cityName, String countryCode) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Icon(Icons.location_city, color: Colors.white70, size: 40),
          const SizedBox(height: 12),
          Text(cityName,
              style: const TextStyle(
                  color: Colors.white,
